---
{"dg-publish":true,"permalink":"/public/muveszet-menedzsment/","dg-note-properties":{"type":["témakör"],"subject":["művészet menedzsment"]}}
---
...
- Fiát Heni doktori védés (design demokrácia) a MOME-n
	- kultúra kutató, japán színház témájú védése
- Printa Design kiállítás
- [[Simon Márton - Hideg pizza\|Simon Márton - Hideg pizza]]
## Említések

- [[Tara Khozein\|Tara Khozein]]
- [[Koronczi Endre\|Koronczi Endre]]
- [Egy hely (építészfórum)](https://epiteszforum.hu/dosszie/egy-hely)
- [[Anna Margit\|Anna Margit]] magyar festő
- [[Byung-Chul Han\|Byung-Chul Han]] filozófus könyve
- zenész kereső adatbázis (fizetős) ötlete
- [ikon.hu](https://ikon.hu/) - képzőművészeti aktualitások
- [[Maluridé\|Maluridé]] band (elektronika + ének)
- [Libertine könyvesbolt](https://www.libertinekonyvesbolt.hu/)
- design for decline
	- nem fenntartható a növekedés -> stratégiaként felfogni
...
- Hemingway app
- [[Gegedűs Gyöngyi\|Gegedűs Gyöngyi]] vers
- [[Szent Ágoston\|Szent Ágoston]] - idő
- [[John Paulson\|John Paulson]]
- Hiphopera
- [[Weöres Sándor\|Weöres Sándor]] [idézet:: A bolond a saját fejével, a bölcs a te fejeddel ítél rólad]
- Szilágyi Klára - Iniciatikus utak 2013
- Sapientia értekezések
- Pierre Bourdieu
- Angyali párbeszéd film
- Monteverdi birkózókör, Jenes András
- Pintér Béla
- Mátrai Péter
- Három nővér
- A mosoly birodalma
- Yo-Yo Ma hiphop táncosokkal
- The Wall Street Journal
- The Surprising Formula for Becoming an Art Star
- menedzsment hálózatok
	- IAMA
	- AEAA
	- CMA
- Glassyard galéria befuttat
- Ballanescu Quartet
- mtmt.hu
...
- Mi a menedzsment területe?
- Mit lehet menedzselni? (projektek, termékek, márkák)
- Hogyan tervezzünk elõre? (tervezés, stratégia, taktika)
- Hogyan találjuk meg az utunkat? (területek, példaképek, versenytársak)
- Hogyan kapcsolódjunk? (hálózatok)
- Gondolkodás (kreativitás)
- Hogyan hangozzuk saját magunknak? (márkázás)
- Hogyan kommunikáljunk? (online, offline, intro...)
- A fellépés környezete mint kommunikáció
- Ismerjük meg a jogainkat! (jog, szerzői jog)
- Számoljunk! (pénzügyek)
- Papírmunka (adminisztráció) Boldoguljunk! (egészség és mentál)

### X. Hová vezeti az embert a zene?

- szinte mindegy, menedzsmentre mindig szüksége lesz
- menedzsment
	- tervezés
	- szervezés
	- vezetés
	- ellenőrzés - sokszor elfelejtjük
		- folyamatos monitorozás
		- következtetés (csapatban esetleges sérelmek kiküszöbölése)
		- megérte-e (pénzben vagy népszerűségben)
- menedzsment ≠ leadership (utóbbi utat mutat, stratégiát talál ki)
- kit?
	- művészt
	- zenekart/kórust/együttest
- mit?
	- intézményt/helyszínt
	- eseményt/koncertet/turnét
	- céget/disztribúciót
- területek
	- általános/teljes körű
	- booking
	- tartalom (pl. műsor)
	- disztribúció
	- marketing/pr
	- műszaki (hang, világítás, logisztika, catering)
- mire jó?
	- ha nem akarom csinálni (erőforrást vesz el vagy nem értek hozzá)
	- segítségre van szükség
		- szervezés/tárgyalás/megállapodás
		- események
		- új területek
- cég/helyszín/disztribútor
	- bizonyos feladatok
	- minőség/hatékonyságnövelés
	- eredményesség javítása
- a növekedés költségnövekedéssel jár
- szerződés nélkül soha semmit
- menedzser, de hogyan?
	- szerződött menedzser
	- időszakos díjazás
		- kezdő/családtag baráti alapon
		- profi, százalékért
		- támogató szervezetek, pl. [ycat.co.uk](https://www.ycat.co.uk/)
			- brit állami pénzből
			- csúcskategóriás zenész menedzserek
			- 8 klasszikus zenésszel foglalkoznak
			- 1-5 év
			- mentorálnak ingyen
			- beleszólnak sokmindenbe
	- milyen módok?
		- feladatok meghatározása
		- feltételek tárgyalása
		- szerződés
			- százalék esetén nettó összeg alapján
			- fix időtartam
			- adjon elég időt magának a menedzser (koncertnaptár tele van a következő 1-1,5 évre)
- U35 (<35 év)
	- én a piacon
...
- hogyan?
	...
	- stratégia
	- nyomonkövetés
	- tudjunk egy adott célcsoporthoz beszélni
- eml. [[Andreas Vierziger\|Andreas Vierziger]]: [idézet:: Nem szeretem a márkázást a művészekkel kapcsolatban, de el kell ismernem, hogy a márka hordozza a folytonosságot, a tiszta értelmezhetőséget, a hitelességet.]

### X. óra

- 3 mondat magamról
- terv, stratégia, taktika
	- a dolgokhoz hogyan fogok hozzáállni?
	- az egész élet tervezés + újratervezés
	- valamilyen módon lejegyzett valami
	- egy cél elérésének érdekében megteendő lépések megtervezése
	- a taktika olyan a stratégiához képest, mint csata a háborúhoz képest
- stratégia = általános vezetés hivatala, hadvezéri mesterség
	- strategy planner
	- bizonytalan/nem állandó környezet
- taktika: adott cél elérése érdekében megteendő konceptuális cselekvés terve
- design
	- régen a mérnök adta ki a designernek a feladatot, ma épp fordítva
	- design terv/specifikáció egy tárgy/rendszer/cselekvés/folyamat megvalósításához - design thinking - nem lineáris! vissza kell nézni (controlling)
		- emphatise
		- define
		- ideate
		- prototype
		- test
- ne próbáld megúszni az első válasszal!
- merjünk - olvasni, kérdezni, beszélgetni, kételkedni
- 3 kérdés
	- Mi a terved?
	- Mi a stratégiád?
	- Mik a taktikai lépéseid?
- szerzőként/alkotóként saját program trendek helyett
	- nem marketing elvárások mentén építkeznek
	- tudatosság, hogy miben élünk
	- közben menni előre saját elképzelés szerint
- startup: eladható! - hol, mikor
- labirintus -><- útvesztő
	- labirintus: belépek-e vagy sem?
	- útvesztő: folyamatos racionális döntések
- terület (mező) - field theory
	- társadalomtudomány, szociológia
	- olyan területek, melyeknek vannak szereplői, versenyeznek egymással - játékelmélet
	- kétféle attitűd
		- inkumbens (hárító): nem akarják, hogy bármi megváltozzon, mert minden így a legjobb
		- inszurgensek: mező megváltoztatása a cél, hogy versenyezzenek az inkumbensekkel
- területmeghatározás - akár több is
- szerepmeghatározás

### X. óra

- mi a mezőm?
- kik a szereplők benne?
- milyen szereplő vagyok?

- versenytárs elemzés
	- profilozás (kik ők? mi a legfontosabb erősségük?)
	- lehetőségek, veszélyek felmérése
	- stratégia - és taktikatervezés alapja
- benchmarking
	- mitől legjobbak a legjobbak?
	- tanulás, alap az igazításhoz/finomhangoláshoz
- van-e közösségi médium/portál, amely egy adott iparon belül tök jól kiépítették azt, ami lenni akarok a saját mezőmben?
- művészeti élet = szigetvilág
	- gócpontok, HUB-ok, leágazások
	- hol történik (ami nekem kell)?
	- mik/kik a HUB-ok a mezőmben?
		- direkt elérés/indirekt (képviselettel)?
		- hálózat
	- egyszerre több HUB
	- nem kell elköteleződni

### X. óra

- az élet körjárásából néha törjünk ki
- kommunikáció
	- latin "communicare" = megosztani
	- szándékolt jelentésadás közös megegyezésen alapuló jelrendszer és szemiotikai szabályok használatával
	- minden kommunikál
		- nonverbális
			- érintés, időzítés, gesztus, testnyelv, arckifejezés, szemkontaktus, öltözködés, belépés, meghajlás
			- szándékos/nemszándékos jelek (kézrázás, izzadás)
			- paranyelv (ritmus, intonáció, tempó, nyomaték)
			- chemistry (pl. feromon)
		- verbális
			- nyelv
	- [idézet:: "You don't have a second chance to make a first impression."]
- alapkészlet
	- életrajz, bio, adatok, dokumentáció, fotó, videó, bizonyítványok, stb.
	- rendszeresen frissítve
	- minden aktuális esetben tisztázni: kinek, miért, milyen apropóra, milyen céllal
		- a megfogalmazás lehet emiatt más is
- életrajz
	- lényeg
	- egyértelmű, egységes
	- mindig igazítsuk az aktuális jelentkezéshez
	- figyeljünk az életrajz tartalmára és kinézetre is
	- ellenőrzés (spell check)
- kísérőlevél
	- géppel, nem kézzel (hacsak nem úgy kérik)
	- pontos címzés, név, beosztás, cím (dátum, tárgy)
	- üdvözlés röviden
	- törzsszöveg (miért írok, mit akarok)
	- elköszönés
	- aláírás mindig kék tintával
	- melléklet lista
- prezentáció
	- kigondolni
	- lényeg, üzenet, amit közvetíteni szeretnék
		- ha nem kérdezik, akkor is elmondjuk - politikusok
	- továbbgondolni, megtervezni
	- eszközt választani
	- elkészíteni (komponálni, hangszerelni)
	- forma (ha nem akar vetíteni, ne vetítsen)
	- befejezni, elmenteni
	- gyakorolni
- színpad
	- összhangban a teljes előadás alkotói szándékával
	- annak képe
	- színpad-design/felállás/elrendezés
	- milyen ruha van rajtunk
		- észrevehetőség
		- testszínek
	- mozgás a színpadon
- marketingkommunikáció
	...
	- nem fizetett
		- trendszetterek
		- márkanagykövetek
		- sokszor nekünk revánsabb, hasznosabb
- influenszerek
- kampány
	- stratégiai (generális)
	- taktikai (aktuális)
	- kérdések
		- mi a cél?
		- kihez szólunk?
		...
		- mikor akarjuk?
		- hol akarjuk?
			- Budapestiek kivételével az emberek nem akarnak elmenni egy megyehatárnál többet
		- milyen lehetőségek vannak?
			- személyes kapcsolatok
- hogyan? milyen egy jó reklám?
	- márkaazonos
	- célratörő
	- figyelemfelhívó
	- szándékolt dolgokkal összhangban működik
- post-truth
	- mindegy, mit akarunk sulykolni, ha eléggé nyomjuk a médiában, az emberek elhiszik
- statisztika #később 
- kép #később 
...
> Hogyan?
> Több kis csoport : gyakorlati munka : projektmenedzsment

- Ki vagyok én? (márka áttekintése)
- Projekttervezés (alapok)
- Projekt meghatározása
- Problémából feladat Idözítés
- Költségvetés
- Kommunikáció
- A siker mérése
...
- keressünk lehetőségeket arra, hogyan tudnánk Budapest azon részeibe eljuttatni a zenét, ahol az ritka

### X. óra

- Creative Europe
	- tartalomra lehet pályázni
- ELTE rendezvényszervezőseinek projektjei
- Godot Art Gallery
- Corvinus, MOME, BME helyszínei, Károli HTK Ráday utca
- kutassunk!
- helyek, ahonnan az emberek nem mehetnek ki
	- kórház
	- idősotthon
	- iskola
- Erasmus szervezeti emailek folyton mennek ki - mi is küldhetnénk
- villamosmegállók
- piacok
- mi a projekt?
- ötleten túl megpróbáljuk eladni
	- one pager
		- jó cím
- concertbooking
...
Széll Ágnes projektvezetö és Csonka András
programigazgató
elõzetes bejelentkezés alapján
karrieriroda@zeneakademia.hu
2. Focus On YOU- workshopok és mentorprogram
https://focusonyouclassical.com/
